...
static const u16 sMapSectionTopLeftCorners[MAPSEC_COUNT][2] = {
    ...
    [MAPSEC_ROUTE_28            - MAPSECS_KANTO] = { 1,  8},
...
static const u16 sMapSectionDimensions[MAPSEC_COUNT][2] = {
    ...
    [MAPSEC_ROUTE_28            - MAPSECS_KANTO] = {1, 1},
...
static const u8 sRegionMapSections_Kanto[LAYER_COUNT][MAP_HEIGHT][MAP_WIDTH] = {
    [LAYER_MAP] = 
    {
        ...
        {MAPSEC_MT_SILVER_EXTERIOR, MAPSEC_ROUTE_28, MAPSEC_ROUTE_22, MAPSEC_ROUTE_22, MAPSEC_VIRIDIAN_CITY, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_ROUTE_17, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_ROUTE_6, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_ROUTE_12, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE},
    ...
    [LAYER_DUNGEON] =
    {
        ...
        {MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE},
        {MAPSEC_MT_SILVER, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE},
...
static void CreateDungeonIconSprite(u8 whichMap, u8 numIcons, u16 x, u16 y, u8 tileTag, u8 palTag)
{
    ...
    if ((GetMapsecType(mapsec) == MAPSECTYPE_VISITED || GetMapsecType(mapsec) == MAPSECTYPE_NOT_VISITED)
     && mapsec != MAPSEC_ROUTE_10_POKECENTER && mapsec != MAPSEC_MT_SILVER_EXTERIOR)
        offset = 2;
...
u8 *GetMapName(u8 *dst0, u16 mapsec, u16 fill)
{
    ...
    if ((idx = mapsec - MAPSECS_KANTO) < MAPSEC_NONE - MAPSECS_KANTO)
    {
        ...
        else if (mapsec == MAPSEC_MT_SILVER_EXTERIOR)
            dst = StringCopy(dst0, gMapSecName_Route28);
        else
