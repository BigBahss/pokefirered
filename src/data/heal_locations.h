static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_MT_SILVER_EXTERIOR - 1] = {MAP_GROUP(MT_SILVER_EXTERIOR), MAP_NUM(MT_SILVER_EXTERIOR), 24, 19},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_MT_SILVER_EXTERIOR - 1] = {MAP_GROUP(MT_SILVER_POKEMON_CENTER_1F), MAP_NUM(MT_SILVER_POKEMON_CENTER_1F)},
};
