...
#define MOVEMENT_ACTION_RUN_DOWN_SLOW                   0xAA
#define MOVEMENT_ACTION_RUN_UP_SLOW                     0xAB
#define MOVEMENT_ACTION_RUN_LEFT_SLOW                   0xAC
#define MOVEMENT_ACTION_RUN_RIGHT_SLOW                  0xAD
// sideways stairs - walking
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_UP_LEFT            0xAE
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_UP_RIGHT           0xAF
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_DOWN_LEFT          0xB0
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_DOWN_RIGHT         0xB1
// sideways stairs - running
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_UP_LEFT_RUNNING    0xB2
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_UP_RIGHT_RUNNING   0xB3
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_DOWN_LEFT_RUNNING  0xB4
#define MOVEMENT_ACTION_WALK_STAIRS_DIAGONAL_DOWN_RIGHT_RUNNING 0xB5
// sideways stairs - acro bike
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_UP_LEFT              0xB6
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_UP_RIGHT             0xB7
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_DOWN_LEFT            0xB8
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_DOWN_RIGHT           0xB9
